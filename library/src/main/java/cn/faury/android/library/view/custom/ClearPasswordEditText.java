...
import cn.faury.android.library.view.custom.common.CommonTextWatcher;


public class ClearPasswordEditText extends android.support.v7.widget.AppCompatEditText{


    //按钮资源
    private final int CLEAR = R.mipmap.f_cvl_clear_editor_clear_icon;
    //动画时长
    ...
    public ClearPasswordEditText(final Context context) {
        super(context);
        init(context);
    }

    public ClearPasswordEditText(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ClearPasswordEditText(final Context context, final AttributeSet attrs, final int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        addTextChangedListener(new CommonTextWatcher(getContext() , this));
    }
...
//        DrawableCompat.setTint(wrappedDrawable, getCurrentHintTextColor());
        return drawableToBitamp(drawable);
    }
