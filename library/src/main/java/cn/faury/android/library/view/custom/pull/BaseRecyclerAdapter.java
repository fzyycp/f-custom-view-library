    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VIEW_TYPE_LOAD_MORE:
                ...
                View footerView = LayoutInflater.from(parent.getContext()).inflate(R.layout.f_cvl_pull_recycler_view_load_more, parent, false);
                viewHolder = new BaseViewHolder(footerView);
                break;
            case VIEW_TYPE_LOAD_DONE:
                View tipView = LayoutInflater.from(parent.getContext()).inflate(R.layout.f_cvl_pull_recycler_view_load_done, parent, false);
                TextView tipTv = tipView.findViewById(R.id.f_cvl_pull_recycler_view_load_done_tips_tv);
