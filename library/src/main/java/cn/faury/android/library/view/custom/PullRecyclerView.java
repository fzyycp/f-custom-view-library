...
import cn.faury.android.library.view.custom.pull.ILayoutManager;
...
public class PullRecyclerView extends FrameLayout implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.f_cvl_pull_recycler_view, this, true);

        swipeRefreshLayout = findViewById(R.id.f_cvl_item_recycler_view_srl);
        swipeRefreshLayout.setOnRefreshListener(this);
        swipeRefreshLayout.setEnabled(true);
        recyclerView = findViewById(R.id.f_cvl_item_recycler_view_rv);
