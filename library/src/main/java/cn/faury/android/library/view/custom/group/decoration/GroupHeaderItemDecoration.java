package cn.faury.android.library.view.custom.group.decoration;
...
public class GroupHeaderItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public GroupHeaderItemDecoration(Context context) {
        ...
        groupHeaderHeight = WindowUtils.dip2px(context, 20);
        ...
        mTextPaint.setTextSize(WindowUtils.sp2px(context, 14));
    }
    ...
    private void drawGroupHeader(Canvas c, RecyclerView parent, View view, String tag) {
        ...
        int y = params[1] + (groupHeaderHeight + WindowUtils.getTextHeight(mTextPaint, tag)) / 2;
    ...
    public GroupHeaderItemDecoration setGroupHeaderLeftPadding(int groupHeaderLeftPadding) {
        this.groupHeaderLeftPadding = WindowUtils.dip2px(context, groupHeaderLeftPadding);
        return this;
    }
    ...
    public GroupHeaderItemDecoration setGroupHeaderTextSize(float groupHeaderTextSize) {
    ...
    public GroupHeaderItemDecoration setGroupHeaderHeight(int groupHeaderHeight) {
        this.groupHeaderHeight = WindowUtils.dip2px(context, groupHeaderHeight);
        return this;
    }
    ...
    public interface OnDrawItemDecorationListener {
         ...
         */
        void onDrawGroupHeader(Canvas canvas, Paint paint, TextPaint textPaint, int[] params, int position);
